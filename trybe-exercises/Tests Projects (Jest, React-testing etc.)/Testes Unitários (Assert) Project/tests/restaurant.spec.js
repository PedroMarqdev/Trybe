...
describe('#createMenu', () => {
  it('tests the function has the correct behaviour', () => {
    const objetoRetornado = createMenu({ food: {'coxinha': 3.90, 'sanduiche': 9.90}, drink: {'agua': 3.90, 'cerveja': 6.90}});
    assert.deepStrictEqual(objetoRetornado.fetchMenu, { food: {'coxinha': 3.90, 'sanduiche': 9.90}, drink: {'agua': 3.90, 'cerveja': 6.90}})
    assert.deepStrictEqual(objetoRetornado.fetchMenu, { food: {'coxinha': 3.90, 'sanduiche': 9.90}, drink: {'agua': 3.90, 'cerveja': 6.90}})
